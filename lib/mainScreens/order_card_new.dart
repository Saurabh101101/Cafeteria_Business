import 'package:cafeteria_business/mainScreens/order_details_screen_new.dart';
import 'package:cafeteria_business/mainScreens/order_details_screen.dart';
...
class OrderCardNew extends StatelessWidget
{
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: ()
      {
        Navigator.push(context, MaterialPageRoute(builder: (c)=> OrderDetailsScreenNew(orderID: orderID)));
      },
      child: Container(
